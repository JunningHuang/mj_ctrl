...
class HybridControlEnv:
    ...
    def __init__(
        ...
        self.contact_q0 = np.array(
            [0.183734, 0.695778, -0.127351, -2.241034, 0.179504, 2.845183, 0.6684]
        )
    ...
    def _sample_trajectory(self) -> None:
        ...
        if traj_type == "circle":
            ...
            angular_speed = random.uniform(2 * np.pi, 3.0 * np.pi)
            ...
            base_freq  = random.uniform(0.75, 1.25)
            ...
            amplitude       = random.uniform(0.05, 0.1)
            frequency       = random.uniform(1.5, 2.2)
